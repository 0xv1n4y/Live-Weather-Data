...
const CardContainer = styled.div`
  ...
  ${mobile({ display: "grid", placeItems: "center" })}
`;
          ...
          <CardContainer>
            <Card>
              ...
              <MinMaxContainer>
                <MinMax isMax>
                  <Heading>Max</Heading>
                  <Temp>{weatherData.main.temp_min}°</Temp>
                </MinMax>
                <MinMax>
                  <Heading>Min</Heading>
                  <Temp>{weatherData.main.temp_max}°</Temp>
                </MinMax>
              </MinMaxContainer>
            </Card>
          </CardContainer>
        ...
        <div>
          <Container>
            <CardContainer>
              <Card>
                <City>PINK CITY</City>
                <Weather>PARTILY CLOUDY</Weather>
                <svg
                  version="1.1"
                  id="Layer_1"
                  x="0px"
